...
//   return (
//     <div className="min-h-screen bg-[#f2e8ff] p-4">
//       {/* BACK BUTTON */}
//       <button
//         onClick={() => navigate(-1)}
...
//       {/* MAIN CARD */}
//       <div className="bg-[#f7f0ff] border border-purple-300 rounded-3xl p-6 shadow-lg relative">

//         {/* BADGE (Celebrity / Rising Star) */}
//         {/* <span className="absolute top-3 left-3 bg-purple-700 text-white px-3 py-1 text-xs rounded-md rotate-[-10deg]">
//           Celebrity
//         </span> */}
...
//             <img
//               src={expert.image}
//               className="w-40 h-40 rounded-full border-4 border-purple-400 shadow-md object-cover"
//             />
...
//             <p className="text-gray-700 text-lg mt-1">{expert.skills}</p>
//             <p className="text-gray-700">{expert.languages}</p>

//             <p className="mt-2 font-semibold text-gray-800">Exp: {expert.experience}</p>
...
//             {/* STATS */}
//             <div className="flex gap-6 text-gray-700 mt-3 font-medium">
//               <span>💬 {expert.chatMins} mins</span>
//               <span>📞 {expert.callMins} mins</span>
//             </div>
...
//   className="flex-1 border border-red-400 text-red-500 py-3 rounded-full text-lg font-semibold hover:bg-red-100"
// >
//   <MessageCircle size={20} className="inline-block mr-2" />
//   Start Chat
//   <div className="text-xs text-red-600">{expert.wait}</div>
// </button>
...
//         <div className="bg-[#e3f7c7] p-6 rounded-xl shadow-xl text-center w-[90%] sm:w-[400px]">

//       <p className="text-gray-800 text-lg font-medium mb-4">
//         Minimum balance of 5 minutes (₹ {expert.price * 5}) is required 
...
//           }}
//           className="px-6 py-2 border border-green-600 text-green-700 rounded-lg hover:bg-green-100"
//         >
//           Recharge
//         </button>
...
//               key={i}
//               src={img}
//               className="rounded-xl h-40 w-full object-cover border border-purple-200"
//             />
//           ))}
//         </div> */}
